		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					function drawChart() {
 					...
 					$query = "SELECT CONCAT(data,' ',timp) AS dat, val FROM miscare ORDER BY id DESC LIMIT 300";

 					$exec = mysqli_query($con,$query);
 					while($row = mysqli_fetch_array($exec)){

 						echo "['".$row['dat']."',".$row['val']."],";
 					}
 					?>
					...
					$sql = 'SELECT id,data,timp,miscare FROM miscare ORDER BY id DESC LIMIT 50';
			...
			<body>
				...
				<table class="data-table">
					<caption class="title">Monitorizare mișcare</caption>
					<thead>
						<tr>
							<th>ID</th>
							<th>DATA</th>
